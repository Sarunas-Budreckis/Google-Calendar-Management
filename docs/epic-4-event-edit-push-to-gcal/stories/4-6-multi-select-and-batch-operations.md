...
- The repo is a flat WinUI 3 app. Keep all work inside the existing root folders: `Views/`, `ViewModels/`, `Services/`, `Models/`, `Messages/`, and `Data/`. Do **not** introduce `Core/`, `src/`, or a second UI assembly. [Source: docs/epic-4-event-edit-push-to-gcal/tech-spec.md#System Architecture Alignment]
...
- Shift-range selection applies only to **timed** events because the tech spec explicitly excludes all-day events from range selection. Keep all-day events single-toggle only. [Source: docs/epic-4-event-edit-push-to-gcal/tech-spec.md#Story 4.6 — Multi-Select and Batch Operations]
...
- [Source: docs/epic-4-event-edit-push-to-gcal/tech-spec.md#Story 4.6 — Multi-Select and Batch Operations]
- [Source: docs/epic-4-event-edit-push-to-gcal/tech-spec.md#System Architecture Alignment]
- [Source: docs/epic-4-event-edit-push-to-gcal/tech-spec.md#Detailed Design]
- [Source: docs/epic-4-event-edit-push-to-gcal/tech-spec.md#Test Strategy Summary]
- [Source: docs/epic-4-event-edit-push-to-gcal/stories/4-1-implement-event-editing-panel.md#Acceptance Criteria]
- [Source: docs/epic-4-event-edit-push-to-gcal/stories/4-3-implement-color-picker-for-event-colors.md#Acceptance Criteria]
