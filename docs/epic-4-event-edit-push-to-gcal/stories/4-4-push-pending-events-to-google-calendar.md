...
Story 4.4 assumes the post-4.2 / 4.3 contract from `docs/epic-4-event-edit-push-to-gcal/tech-spec.md`, not the older branch shape. If the branch still lacks the Story 4.2 schema widening and source-agnostic event identity, land those prerequisites first rather than working around them inside publish code.
...
Story 4.4 expects the `PendingEvent` shape described in `docs/epic-4-event-edit-push-to-gcal/tech-spec.md`, including:
...
- `docs/epic-4-event-edit-push-to-gcal/tech-spec.md` - `Story 4.4 — Push Pending Events to Google Calendar`
- `docs/epic-4-event-edit-push-to-gcal/tech-spec.md` - `Design note — unified save path`
- `docs/epic-4-event-edit-push-to-gcal/tech-spec.md` - `Risks, Assumptions, Open Questions` (`R1`, `A3`)
