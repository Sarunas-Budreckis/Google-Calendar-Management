...
If those prerequisites are still missing when implementation starts, finish Story 4.2 first rather than adding a second temporary creation path. [Source: `docs/epic-4-event-edit-push-to-gcal/tech-spec.md` Risks `R2`, `R4`; `docs/epic-4-event-edit-push-to-gcal/stories/4-2-implement-event-creation-drag-to-create-and-button.md`]
...
[Source: `docs/epic-4-event-edit-push-to-gcal/tech-spec.md` Story 4.8 core flow; `Views/MonthViewLayoutPlanner.cs`; `Services/YearViewDayProjectionBuilder.cs`; `Services/CalendarQueryService.cs`]
...
- `docs/epic-4-event-edit-push-to-gcal/tech-spec.md` - Story 4.8 core flow, Risks `R2` / `R4`, Test Strategy Summary
- `docs/epic-4-event-edit-push-to-gcal/stories/4-2-implement-event-creation-drag-to-create-and-button.md` - authoritative pending-draft creation path and source-agnostic contract dependency
- `docs/epic-3-ui-event-management/stories/3-9-enhance-year-view-with-event-indicators-and-all-day-previews.md` - accepted Year view interaction model and all-day preview rules
