...
**Problem:** Deleting a GCal event (staging) and deleting a local candidate event (autogenerated) both show confirmation dialogs, adding unnecessary friction to common operations.
