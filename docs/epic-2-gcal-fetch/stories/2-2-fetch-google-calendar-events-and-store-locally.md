...
- [Story 1.6 logging conventions](../../epic-1-dotnet-application/stories/1-6-implement-application-logging-and-error-handling-infrastructure.md) - existing DI and logging guardrails
