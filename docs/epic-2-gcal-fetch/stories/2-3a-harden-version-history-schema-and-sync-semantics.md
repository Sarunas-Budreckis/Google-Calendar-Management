...
- [x] **Task 6: Clean up documentation drift around `EventDataJson`** (AC: 2.3A.4, 2.3A.5)
  ...
  - [x] Update `docs/epic-1-dotnet-application/stories/1-3-implement-core-database-schema-tier-1-tables.md` if it still implies JSON-based version rows as the active design
...
- Updated `docs/epic-1-dotnet-application/stories/1-3-implement-core-database-schema-tier-1-tables.md` completion note to reference the FK hardening in Story 2.3A.
...
- docs/epics.md
- docs/epic-1-dotnet-application/stories/1-3-implement-core-database-schema-tier-1-tables.md
- docs/epic-2-gcal-fetch/stories/2-3a-harden-version-history-schema-and-sync-semantics.md
