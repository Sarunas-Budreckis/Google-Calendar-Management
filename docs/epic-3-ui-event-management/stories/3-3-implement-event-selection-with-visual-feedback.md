...
- [Epic 3 tech spec](docs/epic-3-ui-event-management/tech-spec.md) — AC and flow definitions (note: spec uses `int Id`, actual code uses `string GcalEventId`)
...
- docs/epic-3-ui-event-management/stories/3-3-implement-event-selection-with-visual-feedback.context.xml
- docs/epic-3-ui-event-management/stories/3-3-implement-event-selection-with-visual-feedback.md
