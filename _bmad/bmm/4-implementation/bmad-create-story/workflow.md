...
<step n="2" goal="Load and analyze core artifacts">
  ...
  <check if="story_num > 1">
    <action>Find {{previous_story_num}}: scan {implementation_artifacts}/{{epic_folder}}/stories for the story file with the highest story number less than {{story_num}}</action>
