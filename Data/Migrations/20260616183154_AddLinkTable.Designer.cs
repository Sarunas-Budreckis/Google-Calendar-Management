...
namespace GoogleCalendarManagement.Data.Migrations
{
    ...
    [Migration("20260616183154_AddLinkTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoogleCalendarManagement.Data.Entities.DataPoint", b =>
                {
                    ...
                    b.HasIndex("SourceKey", "StartUtc")
                        .HasDatabaseName("idx_data_point_source_key_start_utc");

                    b.ToTable("data_point", (string)null);
                });
            ...
            modelBuilder.Entity("GoogleCalendarManagement.Data.Entities.Link", b =>
                {
                    ...
                    b.Property<string>("ActionGroupId")
                        .IsRequired()
                        .HasColumnType("TEXT")
                    ...
                    b.HasIndex("ActionGroupId")
                        .HasDatabaseName("idx_link_action_group_id");

                    b.HasIndex("DataPointId")
                        .IsUnique()
                        .HasDatabaseName("idx_link_data_point_id");

                    b.HasIndex("EventId")
                        .HasDatabaseName("idx_link_event_id");

                    b.ToTable("link", t =>
                        {
                            t.HasCheckConstraint("CK_link_origin", "origin IN ('manual','auto_rule')");

                            t.HasCheckConstraint("CK_link_state", "state IN ('linked','ignored')");
                        });
                });
            ...
            modelBuilder.Entity("GoogleCalendarManagement.Data.Entities.Link", b =>
                {
                    b.HasOne("GoogleCalendarManagement.Data.Entities.DataPoint", "DataPoint")
                        .WithMany("Links")
